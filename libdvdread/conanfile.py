...
class LibdvdreadConan(ConanFile):
    ...
    description = "<Description of Libdvdread here>"
    settings = "os", "compiler", "build_type", "arch"
    options = {"shared": [True, False]}
    default_options = "shared=True"
    generators = "pkg_config"

    download_url = 'http://www.videolan.org/pub/videolan/libdvdread/5.0.0/libdvdread-5.0.0.tar.bz2'
    ...
    def build(self):
        ...
        ' --disable-silent-rules --enable-introspection --enable-static --enable-shared'%(os.getcwd(),os.getcwd()))
        self.run('make -j4')
